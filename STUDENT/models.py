...
# description = models.TextField(blank=True, null=True)  # Use TextField
...
program_list = [
    ...
    ('Bachelor of Arts in Kiswahili Linguistics', 'Bachelor of Arts in Kiswahili Linguistics'),
    ...
    ('Diploma in Telecommunication Networks', 'Diploma in Telecommunication Networks'),
...
class Books(models.Model):
    ...
    description = CKEditor5Field('Description', config_name='default')  # Ensure CKEditor5Field is correctly used
